-- при перезапуске снова пытается добавить эти данные и падает,
-- поэтому добавила 1 в имени, чтобы файл не был распознан
-- потом поправим :D
...
INSERT INTO subjects (id, name) VALUES (5, 'Canada');